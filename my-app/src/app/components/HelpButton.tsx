...
export default function HelpButton({ params }: { params: { type: number } }) {
  const instructions: Record<number, string> = {
    ...
    3: "Посмотри на изображение, постарайся запомнить его детали, а затем нарисуй его по памяти. Нельзя рисовать буквы и цифры!",
    4: "Используй своё воображение, придумай что-то необычное или интересное, а затем нарисуй это так, как ты это представляешь. Нельзя рисовать буквы и цифры!",
